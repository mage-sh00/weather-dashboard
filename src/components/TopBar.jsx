      ...
      <div style={{ display: "flex", width: "100%", justifyContent: "space-between", alignItems: "center" }}>
        ...
        {!isMobile && (
          <div style={{ display: "flex", gap: 8, alignItems: "center" }}>
            ...
            <div style={iconBox}><Icon d={icons.calendar} size={16} color="#666" /></div>
            <div style={iconBox}><Icon d={icons.chat} size={16} color="#666" /></div>
      ...
      <div style={{
        ...
        <input
          ...
          style={{
            ...
            fontSize: 13, color: darkMode ? "#eee" : "#555", width: "100%",
          }}
          onKeyDown={(e) => {
        ...
        <button
          ...
          style={{
            border: "none", background: "#e87722", color: "white",
...
const badge = {
  ...
  width: 16, height: 16, background: "#e74c3c",
